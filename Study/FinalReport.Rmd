...
### Data Exploratory
The dataset has been downloaded from the open data French government [4]. This dataset is about the poluants emission for the cars sold in France during the year 2015 up to October 2015. The file comes as zipped a csv file. The csv used a ";" as separator and the encoding is not UTF-8 but latin1. 
...
[4] Cars sold in France for 2015 dataset: https://www.data.gouv.fr/fr/datasets/emissions-de-co2-et-de-polluants-des-vehicules-commercialises-en-france
